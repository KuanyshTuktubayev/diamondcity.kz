...
Simditor.i18n = {
  ...
  'ru-RU': {
    ...
    'externalImage': 'Внешний Рисунок',
    'uploadImage': 'Загрузить Рисунок',
    'uploadFailed': 'Ошибка Загрузки',
    'uploadError': 'Ошибка возникла при загрузке',
    'imageUrl': 'Ссылка',
    'imageSize': 'Размер',
    'imageAlt': 'Кодовое Описание',
    'restoreImageSize': 'Вернуть Оригинальный Размер',
    'uploading': 'Загрузка',
    'indent': 'Отступ',
    'outdent': 'Выступ',
    'italic': 'Курсив',
